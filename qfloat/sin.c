...
static short P1[] = {0x3fe9,0x21fb,0x4000,0x0000};
static short P2[] = {0x3e64,0x442d,0x0000,0x0000};
static short P3[] = {0x3ce8,0x4698,0x98cc,0x5170};
#define DP1 *(double *)P1
#define DP2 *(double *)P2
#define DP3 *(double *)P3
#endif
